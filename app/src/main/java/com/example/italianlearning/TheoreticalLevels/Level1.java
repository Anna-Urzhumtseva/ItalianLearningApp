...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level1); //установили текст "Уровень X"

        //начало наполнение уровня

        TextView text = findViewById(R.id.text);
        text.setText(R.string.lvl1_center);
        TextView text_right1 = findViewById(R.id.text_right1);
        text_right1.setText(R.string.lvl1_text_right1);
        TextView text_left1 = findViewById(R.id.text_left1);
        text_left1.setText(R.string.lvl1_text_left1);
        TextView text_center2 = findViewById(R.id.text_center2);
        text_center2.setText(R.string.lvl1_center2);
