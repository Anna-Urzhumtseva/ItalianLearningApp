...
public class Level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level9); //установили текст "Уровень X"
        ...
        text.setText(R.string.lvl9_center);
        TextView text_right1 = findViewById(R.id.text_right1);
        text_right1.setText(R.string.lvl9_text_right1);
        TextView text_left1 = findViewById(R.id.text_left1);
        text_left1.setText(R.string.lvl9_text_left1);
        TextView text_center2 = findViewById(R.id.text_center2);
        text_center2.setText(R.string.lvl9_center2);
        ...
        button_back2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    Intent intent = new Intent(Level9.this, Level8.class);
                    startActivity(intent); finish();
                }catch (Exception e){
