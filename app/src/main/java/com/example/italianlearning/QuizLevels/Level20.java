...
public class Level20 extends AppCompatActivity implements View.OnClickListener {
    ...
    int totalQuestions = QuestionAnswer.question2.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level20); //установили текст "Уровень X"
    ...
    public void onClick(View view) {
        ...
        if(clicledButton.getId()==R.id.answer){
            if(selectedAnswers.equals(QuestionAnswer.correctAnswers2[currentQuestionIndex])){
                score++;
            }
    ...
    void loadNewQuestion(){
        ...
        question1.setText(QuestionAnswer.question2[currentQuestionIndex]);
        ans_a.setText(QuestionAnswer.choises2[currentQuestionIndex][0]);
        ans_b.setText(QuestionAnswer.choises2[currentQuestionIndex][1]);
        ans_c.setText(QuestionAnswer.choises2[currentQuestionIndex][2]);
        ans_d.setText(QuestionAnswer.choises2[currentQuestionIndex][3]);
    }
    void backGameLevels(){
        if(currentQuestionIndex == totalQuestions){
            try{
